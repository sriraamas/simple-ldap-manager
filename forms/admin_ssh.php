...
<form id="adminSsh" action="/admin/revoke.php" method="POST" data-abide>
<div>
  <?php 
  ...
  ?>  
      ...
      <br>
      <div>
      <p class="sectionHead">Revoke SSH Credentials</p>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 push-1 columns">
          <input type="submit" value="Revoke SSH" class="button radius mybutton"/>
